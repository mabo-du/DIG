...
class SliceNavigator(QDockWidget):
    ...
    def update_slices(self, inline_idx: int, crossline_idx: int, depth_idx: int) -> None:
        ...
        self.inline_view.set_data(
            inline_data, sample_interval_ns=self.grid.sample_interval_ns, time_zero_ns=0.0
        )
        ...
        self.crossline_view.set_data(
            crossline_data, sample_interval_ns=self.grid.sample_interval_ns, time_zero_ns=0.0
        )
        ...
        self.time_slice_view.set_data(
            time_slice_data, sample_interval_ns=self.grid.crossline_spacing_m, time_zero_ns=0.0
        )
